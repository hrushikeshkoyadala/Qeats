...
from restaurants.clarifai_tag_suggestions import get_access_token, get_tags_suggestions
...
class GetTags(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        tags = get_tags_suggestions(get_access_token('CLARIFAI_API_KEY'), image_url)
        return JsonResponse(tags, safe=False)
